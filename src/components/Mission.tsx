  ...
  return (
    <section className="py-32 bg-art-cream">
      <div className="container mx-auto px-4 max-w-5xl text-center">
        <h2 className="text-5xl font-display mb-12 text-art-forest tracking-wide">Our Vision</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          {["Authentication", "Tokenization", "Trading"].map((feature) => (
            <div
              key={feature}
              className="p-8 border border-art-forest/10 hover:border-art-forest/30 transition-colors duration-300 animate-slideUp"
            >
              <h3 className="text-2xl font-display mb-4 text-art-forest">{feature}</h3>
